...
namespace CSharpHomes.Utilities
{
    ...
    public static class RibbonUtils
    {
        ...
        public static PushButtonData NewPushButtonData<CommandClass>(string buttonName)
        {
            ...
            pushButtonData.SetImage($"Resources/IconsTiff/{baseName}.tiff");
            pushButtonData.SetLargeImage($"Resources/IconsTiff/{baseName}.tiff");
        ...
        public static PulldownButtonData NewPulldownButtonData(string buttonName, string nameSpace)
        {
            ...
            //     // Set the values
            //     ToolTip = LookupTooltip(baseName),
            //     Image = GetIcon(baseName, 16),
            //     LargeImage = GetIcon(baseName,  32)
            // };
            pulldownButtonData.ToolTip = LookupTooltip(baseName);
            pulldownButtonData.SetImage($"Resources/IconsTiff/{baseName}.tiff");
            pulldownButtonData.SetLargeImage($"Resources/IconsTiff/{baseName}.tiff");
        ...
        {
            // return commandName.Replace("CSharpHomes.Commands.", "");
            return commandName.Replace("CSharpHomes.Cmds", "").Replace(".Cmd", "");
        }
        ...
        public static ImageSource GetIcon(string baseName, int resolution = 32)
        {
            ...
            var resourcePath = $"{Globals.AddinName}.Resources.Icons.{baseName}{resolution}.png";
